...
def exteraction_feature(hs_amps_path,num_feature):
    ...
    for i,state,amp in zip(data_number,hs_state,hs_amps):
        ...
        enhance_mel1,enhance_mel2 = total_frequency(np.array(enhance_list,dtype='float32'))
...
if __name__ ==  "__main__":
    ...
    out_file = '/home/deep/heart_science/data_feature0.csv'
    try:
